...
- `docs/LEARN.md` — the operator's personal crypto glossary, maintained via the `/learn` slash command (`.claude/commands/learn.md`). Append-only; not developer documentation.
